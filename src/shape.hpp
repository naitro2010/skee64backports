...
namespace Morpher {
    ...
    struct Triangle {
            ...
            bool CompareIndices(const Triangle& other) const {
                return ((p1 == other.p1 || p1 == other.p2 || p1 == other.p3) && (p2 == other.p1 || p2 == other.p2 || p2 == other.p3) &&
...
namespace std {
    ...
    template <>
    struct equal_to<Morpher::Triangle> {
